...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ln,depthTest:!1,depthWrite:!1})}function Sa(){return new dn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:as(),fragmentShader:`
		...
		`,blending:ln,depthTest:!1,depthWrite:!1})}function ya(){return new dn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:as(),fragmentShader:`
...
#define LOW_PRECISION`),e}function Ef(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Wa?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===Io?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===$t&&(e="SHADOWMAP_TYPE_VSM"),e}function Sf(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case ei:case ti:e="ENVMAP_TYPE_CUBE";break;case tr:e="ENVMAP_TYPE_CUBE_UV";break}return e}function yf(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case ti:e="ENVMAP_MODE_REFRACTION";break}return e}function Tf(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Xa:e="ENVMAP_BLENDING_MULTIPLY";break;case rl:e="ENVMAP_BLENDING_MIX";break;case sl:e="ENVMAP_BLENDING_ADD";break}return e}function Af(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function bf(i,e,t,n){const r=i.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=Ef(t),c=Sf(t),u=yf(t),f=Tf(t),p=Af(t),m=t.isWebGL2?"":df(t),_=ff(t),M=pf(s),d=r.createProgram();let h,y,g=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+y);const R=g+h+o,P=g+y+a,C=La(r,r.VERTEX_SHADER,R),w=La(r,r.FRAGMENT_SHADER,P);r.attachShader(d,C),r.attachShader(d,w),t.index0AttributeName!==void 0?r.bindAttribLocation(d,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(d,0,"position"),r.linkProgram(d);function V(X){if(i.debug.checkShaderErrors){const ne=r.getProgramInfoLog(d).trim(),L=r.getShaderInfoLog(C).trim(),G=r.getShaderInfoLog(w).trim();let z=!0,Y=!0;if(r.getProgramParameter(d,r.LINK_STATUS)===!1)if(z=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,d,C,w);else{const W=Pa(r,C,"vertex"),k=Pa(r,w,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(d,r.VALIDATE_STATUS)+`
...
}`;function Wf(i,e,t){let n=new mo;const r=new Fe,s=new Fe,o=new ht,a=new Gf({depthPacking:El}),l=new Hf,c={},u=t.maxTextureSize,f={[un]:Et,[Et]:un,[jt]:jt},p=new dn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Fe},radius:{value:4}},vertexShader:Vf,fragmentShader:kf}),m=p.clone();m.defines.HORIZONTAL_PASS=1;const _=new fn;_.setAttribute("position",new zt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const M=new Bt(_,p),d=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Wa;let h=this.type;this.render=function(C,w,V){if(d.enabled===!1||d.autoUpdate===!1&&d.needsUpdate===!1||C.length===0)return;const re=i.getRenderTarget(),x=i.getActiveCubeFace(),A=i.getActiveMipmapLevel(),X=i.state;X.setBlending(ln),X.buffers.color.setClear(1,1,1,1),X.buffers.depth.setTest(!0),X.setScissorTest(!1);const ne=h!==$t&&this.type===$t,L=h===$t&&this.type!==$t;for(let G=0,z=C.length;G<z;G++){const Y=C[G],W=Y.shadow;if(W===void 0){console.warn("THREE.WebGLShadowMap:",Y,"has no shadow.");continue}if(W.autoUpdate===!1&&W.needsUpdate===!1)continue;r.copy(W.mapSize);const k=W.getFrameExtents();if(r.multiply(k),s.copy(W.mapSize),(r.x>u||r.y>u)&&(r.x>u&&(s.x=Math.floor(u/k.x),r.x=s.x*k.x,W.mapSize.x=s.x),r.y>u&&(s.y=Math.floor(u/k.y),r.y=s.y*k.y,W.mapSize.y=s.y)),W.map===null||ne===!0||L===!0){const J=this.type!==$t?{minFilter:xt,magFilter:xt}:{};W.map!==null&&W.map.dispose(),W.map=new wn(r.x,r.y,J),W.map.texture.name=Y.name+".shadowMap",W.camera.updateProjectionMatrix()}i.setRenderTarget(W.map),i.clear();const K=W.getViewportCount();for(let J=0;J<K;J++){const de=W.getViewport(J);o.set(s.x*de.x,s.y*de.y,s.x*de.z,s.y*de.w),X.viewport(o),W.updateMatrices(Y,J),n=W.getFrustum(),R(w,V,W.camera,Y,this.type)}W.isPointLightShadow!==!0&&this.type===$t&&y(W,V),W.needsUpdate=!1}h=this.type,d.needsUpdate=!1,i.setRenderTarget(re,x,A)};function y(C,w){const V=e.update(M);p.defines.VSM_SAMPLES!==C.blurSamples&&(p.defines.VSM_SAMPLES=C.blurSamples,m.defines.VSM_SAMPLES=C.blurSamples,p.needsUpdate=!0,m.needsUpdate=!0),C.mapPass===null&&(C.mapPass=new wn(r.x,r.y)),p.uniforms.shadow_pass.value=C.map.texture,p.uniforms.resolution.value=C.mapSize,p.uniforms.radius.value=C.radius,i.setRenderTarget(C.mapPass),i.clear(),i.renderBufferDirect(w,null,V,p,M,null),m.uniforms.shadow_pass.value=C.mapPass.texture,m.uniforms.resolution.value=C.mapSize,m.uniforms.radius.value=C.radius,i.setRenderTarget(C.map),i.clear(),i.renderBufferDirect(w,null,V,m,M,null)}function g(C,w,V,re){let x=null;const A=V.isPointLight===!0?C.customDistanceMaterial:C.customDepthMaterial;if(A!==void 0)x=A;else if(x=V.isPointLight===!0?l:a,i.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0){const X=x.uuid,ne=w.uuid;let L=c[X];L===void 0&&(L={},c[X]=L);let G=L[ne];G===void 0&&(G=x.clone(),L[ne]=G,w.addEventListener("dispose",P)),x=G}if(x.visible=w.visible,x.wireframe=w.wireframe,re===$t?x.side=w.shadowSide!==null?w.shadowSide:w.side:x.side=w.shadowSide!==null?w.shadowSide:f[w.side],x.alphaMap=w.alphaMap,x.alphaTest=w.alphaTest,x.map=w.map,x.clipShadows=w.clipShadows,x.clippingPlanes=w.clippingPlanes,x.clipIntersection=w.clipIntersection,x.displacementMap=w.displacementMap,x.displacementScale=w.displacementScale,x.displacementBias=w.displacementBias,x.wireframeLinewidth=w.wireframeLinewidth,x.linewidth=w.linewidth,V.isPointLight===!0&&x.isMeshDistanceMaterial===!0){const X=i.properties.get(x);X.light=V}return x}function R(C,w,V,re,x){if(C.visible===!1)return;if(C.layers.test(w.layers)&&(C.isMesh||C.isLine||C.isPoints)&&(C.castShadow||C.receiveShadow&&x===$t)&&(!C.frustumCulled||n.intersectsObject(C))){C.modelViewMatrix.multiplyMatrices(V.matrixWorldInverse,C.matrixWorld);const ne=e.update(C),L=C.material;if(Array.isArray(L)){const G=ne.groups;for(let z=0,Y=G.length;z<Y;z++){const W=G[z],k=L[W.materialIndex];if(k&&k.visible){const K=g(C,k,re,x);C.onBeforeShadow(i,C,w,V,ne,K,W),i.renderBufferDirect(V,null,ne,K,C,W),C.onAfterShadow(i,C,w,V,ne,K,W)}}}else if(L.visible){const G=g(C,L,re,x);C.onBeforeShadow(i,C,w,V,ne,G,null),i.renderBufferDirect(V,null,ne,G,C,null),C.onAfterShadow(i,C,w,V,ne,G,null)}}const X=C.children;for(let ne=0,L=X.length;ne<L;ne++)R(X[ne],w,V,re,x)}function P(C){C.target.removeEventListener("dispose",P);for(const V in c){const re=c[V],x=C.target.uuid;x in re&&(re[x].dispose(),delete re[x])}}}function Xf(i,e,t){const n=t.isWebGL2;function r(){let T=!1;const ee=new ht;let j=null;const me=new ht(0,0,0,0);return{setMask:function(Ee){j!==Ee&&!T&&(i.colorMask(Ee,Ee,Ee,Ee),j=Ee)},setLocked:function(Ee){T=Ee},setClear:function(Ee,We,Ve,je,lt){lt===!0&&(Ee*=je,We*=je,Ve*=je),ee.set(Ee,We,Ve,je),me.equals(ee)===!1&&(i.clearColor(Ee,We,Ve,je),me.copy(ee))},reset:function(){T=!1,j=null,me.set(-1,0,0,0)}}}function s(){let T=!1,ee=null,j=null,me=null;return{setTest:function(Ee){Ee?fe(i.DEPTH_TEST):ke(i.DEPTH_TEST)},setMask:function(Ee){ee!==Ee&&!T&&(i.depthMask(Ee),ee=Ee)},setFunc:function(Ee){if(j!==Ee){switch(Ee){case Zo:i.depthFunc(i.NEVER);break;case Jo:i.depthFunc(i.ALWAYS);break;case Qo:i.depthFunc(i.LESS);break;case $i:i.depthFunc(i.LEQUAL);break;case el:i.depthFunc(i.EQUAL);break;case tl:i.depthFunc(i.GEQUAL);break;case nl:i.depthFunc(i.GREATER);break;case il:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}j=Ee}},setLocked:function(Ee){T=Ee},setClear:function(Ee){me!==Ee&&(i.clearDepth(Ee),me=Ee)},reset:function(){T=!1,ee=null,j=null,me=null}}}function o(){let T=!1,ee=null,j=null,me=null,Ee=null,We=null,Ve=null,je=null,lt=null;return{setTest:function(Xe){T||(Xe?fe(i.STENCIL_TEST):ke(i.STENCIL_TEST))},setMask:function(Xe){ee!==Xe&&!T&&(i.stencilMask(Xe),ee=Xe)},setFunc:function(Xe,et,gt){(j!==Xe||me!==et||Ee!==gt)&&(i.stencilFunc(Xe,et,gt),j=Xe,me=et,Ee=gt)},setOp:function(Xe,et,gt){(We!==Xe||Ve!==et||je!==gt)&&(i.stencilOp(Xe,et,gt),We=Xe,Ve=et,je=gt)},setLocked:function(Xe){T=Xe},setClear:function(Xe){lt!==Xe&&(i.clearStencil(Xe),lt=Xe)},reset:function(){T=!1,ee=null,j=null,me=null,Ee=null,We=null,Ve=null,je=null,lt=null}}}const a=new r,l=new s,c=new o,u=new WeakMap,f=new WeakMap;let p={},m={},_=new WeakMap,M=[],d=null,h=!1,y=null,g=null,R=null,P=null,C=null,w=null,V=null,re=new $e(0,0,0),x=0,A=!1,X=null,ne=null,L=null,G=null,z=null;const Y=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let W=!1,k=0;const K=i.getParameter(i.VERSION);K.indexOf("WebGL")!==-1?(k=parseFloat(/^WebGL (\d)/.exec(K)[1]),W=k>=1):K.indexOf("OpenGL ES")!==-1&&(k=parseFloat(/^OpenGL ES (\d)/.exec(K)[1]),W=k>=2);let J=null,de={};const be=i.getParameter(i.SCISSOR_BOX),H=i.getParameter(i.VIEWPORT),Z=new ht().fromArray(be),he=new ht().fromArray(H);function Se(T,ee,j,me){const Ee=new Uint8Array(4),We=i.createTexture();i.bindTexture(T,We),i.texParameteri(T,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(T,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Ve=0;Ve<j;Ve++)n&&(T===i.TEXTURE_3D||T===i.TEXTURE_2D_ARRAY)?i.texImage3D(ee,0,i.RGBA,1,1,me,0,i.RGBA,i.UNSIGNED_BYTE,Ee):i.texImage2D(ee+Ve,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,Ee);return We}const Te={};Te[i.TEXTURE_2D]=Se(i.TEXTURE_2D,i.TEXTURE_2D,1),Te[i.TEXTURE_CUBE_MAP]=Se(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),n&&(Te[i.TEXTURE_2D_ARRAY]=Se(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),Te[i.TEXTURE_3D]=Se(i.TEXTURE_3D,i.TEXTURE_3D,1,1)),a.setClear(0,0,0,1),l.setClear(1),c.setClear(0),fe(i.DEPTH_TEST),l.setFunc($i),Pe(!1),S(_s),fe(i.CULL_FACE),ge(ln);function fe(T){p[T]!==!0&&(i.enable(T),p[T]=!0)}function ke(T){p[T]!==!1&&(i.disable(T),p[T]=!1)}function Le(T,ee){return m[T]!==ee?(i.bindFramebuffer(T,ee),m[T]=ee,n&&(T===i.DRAW_FRAMEBUFFER&&(m[i.FRAMEBUFFER]=ee),T===i.FRAMEBUFFER&&(m[i.DRAW_FRAMEBUFFER]=ee)),!0):!1}function U(T,ee){let j=M,me=!1;if(T)if(j=_.get(ee),j===void 0&&(j=[],_.set(ee,j)),T.isWebGLMultipleRenderTargets){const Ee=T.texture;if(j.length!==Ee.length||j[0]!==i.COLOR_ATTACHMENT0){for(let We=0,Ve=Ee.length;We<Ve;We++)j[We]=i.COLOR_ATTACHMENT0+We;j.length=Ee.length,me=!0}}else j[0]!==i.COLOR_ATTACHMENT0&&(j[0]=i.COLOR_ATTACHMENT0,me=!0);else j[0]!==i.BACK&&(j[0]=i.BACK,me=!0);me&&(t.isWebGL2?i.drawBuffers(j):e.get("WEBGL_draw_buffers").drawBuffersWEBGL(j))}function it(T){return d!==T?(i.useProgram(T),d=T,!0):!1}const Me={[En]:i.FUNC_ADD,[Fo]:i.FUNC_SUBTRACT,[Oo]:i.FUNC_REVERSE_SUBTRACT};if(n)Me[Es]=i.MIN,Me[Ss]=i.MAX;else{const T=e.get("EXT_blend_minmax");T!==null&&(Me[Es]=T.MIN_EXT,Me[Ss]=T.MAX_EXT)}const we={[Bo]:i.ZERO,[zo]:i.ONE,[Go]:i.SRC_COLOR,[Wr]:i.SRC_ALPHA,[Yo]:i.SRC_ALPHA_SATURATE,[Wo]:i.DST_COLOR,[Vo]:i.DST_ALPHA,[Ho]:i.ONE_MINUS_SRC_COLOR,[Xr]:i.ONE_MINUS_SRC_ALPHA,[Xo]:i.ONE_MINUS_DST_COLOR,[ko]:i.ONE_MINUS_DST_ALPHA,[qo]:i.CONSTANT_COLOR,[$o]:i.ONE_MINUS_CONSTANT_COLOR,[jo]:i.CONSTANT_ALPHA,[Ko]:i.ONE_MINUS_CONSTANT_ALPHA};function ge(T,ee,j,me,Ee,We,Ve,je,lt,Xe){if(T===ln){h===!0&&(ke(i.BLEND),h=!1);return}if(h===!1&&(fe(i.BLEND),h=!0),T!==No){if(T!==y||Xe!==A){if((g!==En||C!==En)&&(i.blendEquation(i.FUNC_ADD),g=En,C=En),Xe)switch(T){case Zn:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case vs:i.blendFunc(i.ONE,i.ONE);break;case xs:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Ms:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",T);break}else switch(T){case Zn:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case vs:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case xs:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Ms:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",T);break}R=null,P=null,w=null,V=null,re.set(0,0,0),x=0,y=T,A=Xe}return}Ee=Ee||ee,We=We||j,Ve=Ve||me,(ee!==g||Ee!==C)&&(i.blendEquationSeparate(Me[ee],Me[Ee]),g=ee,C=Ee),(j!==R||me!==P||We!==w||Ve!==V)&&(i.blendFuncSeparate(we[j],we[me],we[We],we[Ve]),R=j,P=me,w=We,V=Ve),(je.equals(re)===!1||lt!==x)&&(i.blendColor(je.r,je.g,je.b,lt),re.copy(je),x=lt),y=T,A=!1}function Ke(T,ee){T.side===jt?ke(i.CULL_FACE):fe(i.CULL_FACE);let j=T.side===Et;ee&&(j=!j),Pe(j),T.blending===Zn&&T.transparent===!1?ge(ln):ge(T.blending,T.blendEquation,T.blendSrc,T.blendDst,T.blendEquationAlpha,T.blendSrcAlpha,T.blendDstAlpha,T.blendColor,T.blendAlpha,T.premultipliedAlpha),l.setFunc(T.depthFunc),l.setTest(T.depthTest),l.setMask(T.depthWrite),a.setMask(T.colorWrite);const me=T.stencilWrite;c.setTest(me),me&&(c.setMask(T.stencilWriteMask),c.setFunc(T.stencilFunc,T.stencilRef,T.stencilFuncMask),c.setOp(T.stencilFail,T.stencilZFail,T.stencilZPass)),N(T.polygonOffset,T.polygonOffsetFactor,T.polygonOffsetUnits),T.alphaToCoverage===!0?fe(i.SAMPLE_ALPHA_TO_COVERAGE):ke(i.SAMPLE_ALPHA_TO_COVERAGE)}function Pe(T){X!==T&&(T?i.frontFace(i.CW):i.frontFace(i.CCW),X=T)}function S(T){T!==Do?(fe(i.CULL_FACE),T!==ne&&(T===_s?i.cullFace(i.BACK):T===Uo?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):ke(i.CULL_FACE),ne=T}function v(T){T!==L&&(W&&i.lineWidth(T),L=T)}function N(T,ee,j){T?(fe(i.POLYGON_OFFSET_FILL),(G!==ee||z!==j)&&(i.polygonOffset(ee,j),G=ee,z=j)):ke(i.POLYGON_OFFSET_FILL)}function te(T){T?fe(i.SCISSOR_TEST):ke(i.SCISSOR_TEST)}function q(T){T===void 0&&(T=i.TEXTURE0+Y-1),J!==T&&(i.activeTexture(T),J=T)}function Q(T,ee,j){j===void 0&&(J===null?j=i.TEXTURE0+Y-1:j=J);let me=de[j];me===void 0&&(me={type:void 0,texture:void 0},de[j]=me),(me.type!==T||me.texture!==ee)&&(J!==j&&(i.activeTexture(j),J=j),i.bindTexture(T,ee||Te[T]),me.type=T,me.texture=ee)}function pe(){const T=de[J];T!==void 0&&T.type!==void 0&&(i.bindTexture(T.type,null),T.type=void 0,T.texture=void 0)}function ae(){try{i.compressedTexImage2D.apply(i,arguments)}catch(T){console.error("THREE.WebGLState:",T)}}function ue(){try{i.compressedTexImage3D.apply(i,arguments)}catch(T){console.error("THREE.WebGLState:",T)}}function ye(){try{i.texSubImage2D.apply(i,arguments)}catch(T){console.error("THREE.WebGLState:",T)}}function De(){try{i.texSubImage3D.apply(i,arguments)}catch(T){console.error("THREE.WebGLState:",T)}}function $(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(T){console.error("THREE.WebGLState:",T)}}function Ye(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(T){console.error("THREE.WebGLState:",T)}}function Be(){try{i.texStorage2D.apply(i,arguments)}catch(T){console.error("THREE.WebGLState:",T)}}function Re(){try{i.texStorage3D.apply(i,arguments)}catch(T){console.error("THREE.WebGLState:",T)}}function ve(){try{i.texImage2D.apply(i,arguments)}catch(T){console.error("THREE.WebGLState:",T)}}function le(){try{i.texImage3D.apply(i,arguments)}catch(T){console.error("THREE.WebGLState:",T)}}function Ie(T){Z.equals(T)===!1&&(i.scissor(T.x,T.y,T.z,T.w),Z.copy(T))}function b(T){he.equals(T)===!1&&(i.viewport(T.x,T.y,T.z,T.w),he.copy(T))}function ie(T,ee){let j=f.get(ee);j===void 0&&(j=new WeakMap,f.set(ee,j));let me=j.get(T);me===void 0&&(me=i.getUniformBlockIndex(ee,T.name),j.set(T,me))}function oe(T,ee){const me=f.get(ee).get(T);u.get(ee)!==me&&(i.uniformBlockBinding(ee,me,T.__bindingPointIndex),u.set(ee,me))}function xe(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),n===!0&&(i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null)),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),p={},J=null,de={},m={},_=new WeakMap,M=[],d=null,h=!1,y=null,g=null,R=null,P=null,C=null,w=null,V=null,re=new $e(0,0,0),x=0,A=!1,X=null,ne=null,L=null,G=null,z=null,Z.set(0,0,i.canvas.width,i.canvas.height),he.set(0,0,i.canvas.width,i.canvas.height),a.reset(),l.reset(),c.reset()}return{buffers:{color:a,depth:l,stencil:c},enable:fe,disable:ke,bindFramebuffer:Le,drawBuffers:U,useProgram:it,setBlending:ge,setMaterial:Ke,setFlipSided:Pe,setCullFace:S,setLineWidth:v,setPolygonOffset:N,setScissorTest:te,activeTexture:q,bindTexture:Q,unbindTexture:pe,compressedTexImage2D:ae,compressedTexImage3D:ue,texImage2D:ve,texImage3D:le,updateUBOMapping:ie,uniformBlockBinding:oe,texStorage2D:Be,texStorage3D:Re,texSubImage2D:ye,texSubImage3D:De,compressedTexSubImage2D:$,compressedTexSubImage3D:Ye,scissor:Ie,viewport:b,reset:xe}}function Yf(i,e,t,n,r,s,o){const a=r.isWebGL2,l=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),u=new WeakMap;let f;const p=new WeakMap;let m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(S,v){return m?new OffscreenCanvas(S,v):er("canvas")}function M(S,v,N,te){let q=1;if((S.width>te||S.height>te)&&(q=te/Math.max(S.width,S.height)),q<1||v===!0)if(typeof HTMLImageElement<"u"&&S instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&S instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&S instanceof ImageBitmap){const Q=v?Qi:Math.floor,pe=Q(q*S.width),ae=Q(q*S.height);f===void 0&&(f=_(pe,ae));const ue=N?_(pe,ae):f;return ue.width=pe,ue.height=ae,ue.getContext("2d").drawImage(S,0,0,pe,ae),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+S.width+"x"+S.height+") to ("+pe+"x"+ae+")."),ue}else return"data"in S&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+S.width+"x"+S.height+")."),S;return S}function d(S){return Zr(S.width)&&Zr(S.height)}function h(S){return a?!1:S.wrapS!==It||S.wrapT!==It||S.minFilter!==xt&&S.minFilter!==Mt}function y(S,v){return S.generateMipmaps&&v&&S.minFilter!==xt&&S.minFilter!==Mt}function g(S){i.generateMipmap(S)}function R(S,v,N,te,q=!1){if(a===!1)return v;if(S!==null){if(i[S]!==void 0)return i[S];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+S+"'")}let Q=v;if(v===i.RED&&(N===i.FLOAT&&(Q=i.R32F),N===i.HALF_FLOAT&&(Q=i.R16F),N===i.UNSIGNED_BYTE&&(Q=i.R8)),v===i.RED_INTEGER&&(N===i.UNSIGNED_BYTE&&(Q=i.R8UI),N===i.UNSIGNED_SHORT&&(Q=i.R16UI),N===i.UNSIGNED_INT&&(Q=i.R32UI),N===i.BYTE&&(Q=i.R8I),N===i.SHORT&&(Q=i.R16I),N===i.INT&&(Q=i.R32I)),v===i.RG&&(N===i.FLOAT&&(Q=i.RG32F),N===i.HALF_FLOAT&&(Q=i.RG16F),N===i.UNSIGNED_BYTE&&(Q=i.RG8)),v===i.RGBA){const pe=q?ji:qe.getTransfer(te);N===i.FLOAT&&(Q=i.RGBA32F),N===i.HALF_FLOAT&&(Q=i.RGBA16F),N===i.UNSIGNED_BYTE&&(Q=pe===Ze?i.SRGB8_ALPHA8:i.RGBA8),N===i.UNSIGNED_SHORT_4_4_4_4&&(Q=i.RGBA4),N===i.UNSIGNED_SHORT_5_5_5_1&&(Q=i.RGB5_A1)}return(Q===i.R16F||Q===i.R32F||Q===i.RG16F||Q===i.RG32F||Q===i.RGBA16F||Q===i.RGBA32F)&&e.get("EXT_color_buffer_float"),Q}function P(S,v,N){return y(S,N)===!0||S.isFramebufferTexture&&S.minFilter!==xt&&S.minFilter!==Mt?Math.log2(Math.max(v.width,v.height))+1:S.mipmaps!==void 0&&S.mipmaps.length>0?S.mipmaps.length:S.isCompressedTexture&&Array.isArray(S.image)?v.mipmaps.length:1}function C(S){return S===xt||S===ys||S===li?i.NEAREST:i.LINEAR}function w(S){const v=S.target;v.removeEventListener("dispose",w),re(v),v.isVideoTexture&&u.delete(v)}function V(S){const v=S.target;v.removeEventListener("dispose",V),A(v)}function re(S){const v=n.get(S);if(v.__webglInit===void 0)return;const N=S.source,te=p.get(N);if(te){const q=te[v.__cacheKey];q.usedTimes--,q.usedTimes===0&&x(S),Object.keys(te).length===0&&p.delete(N)}n.remove(S)}function x(S){const v=n.get(S);i.deleteTexture(v.__webglTexture);const N=S.source,te=p.get(N);delete te[v.__cacheKey],o.memory.textures--}function A(S){const v=S.texture,N=n.get(S),te=n.get(v);if(te.__webglTexture!==void 0&&(i.deleteTexture(te.__webglTexture),o.memory.textures--),S.depthTexture&&S.depthTexture.dispose(),S.isWebGLCubeRenderTarget)for(let q=0;q<6;q++){if(Array.isArray(N.__webglFramebuffer[q]))for(let Q=0;Q<N.__webglFramebuffer[q].length;Q++)i.deleteFramebuffer(N.__webglFramebuffer[q][Q]);else i.deleteFramebuffer(N.__webglFramebuffer[q]);N.__webglDepthbuffer&&i.deleteRenderbuffer(N.__webglDepthbuffer[q])}else{if(Array.isArray(N.__webglFramebuffer))for(let q=0;q<N.__webglFramebuffer.length;q++)i.deleteFramebuffer(N.__webglFramebuffer[q]);else i.deleteFramebuffer(N.__webglFramebuffer);if(N.__webglDepthbuffer&&i.deleteRenderbuffer(N.__webglDepthbuffer),N.__webglMultisampledFramebuffer&&i.deleteFramebuffer(N.__webglMultisampledFramebuffer),N.__webglColorRenderbuffer)for(let q=0;q<N.__webglColorRenderbuffer.length;q++)N.__webglColorRenderbuffer[q]&&i.deleteRenderbuffer(N.__webglColorRenderbuffer[q]);N.__webglDepthRenderbuffer&&i.deleteRenderbuffer(N.__webglDepthRenderbuffer)}if(S.isWebGLMultipleRenderTargets)for(let q=0,Q=v.length;q<Q;q++){const pe=n.get(v[q]);pe.__webglTexture&&(i.deleteTexture(pe.__webglTexture),o.memory.textures--),n.remove(v[q])}n.remove(v),n.remove(S)}let X=0;function ne(){X=0}function L(){const S=X;return S>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+S+" texture units while this GPU supports only "+r.maxTextures),X+=1,S}function G(S){const v=[];return v.push(S.wrapS),v.push(S.wrapT),v.push(S.wrapR||0),v.push(S.magFilter),v.push(S.minFilter),v.push(S.anisotropy),v.push(S.internalFormat),v.push(S.format),v.push(S.type),v.push(S.generateMipmaps),v.push(S.premultiplyAlpha),v.push(S.flipY),v.push(S.unpackAlignment),v.push(S.colorSpace),v.join()}function z(S,v){const N=n.get(S);if(S.isVideoTexture&&Ke(S),S.isRenderTargetTexture===!1&&S.version>0&&N.__version!==S.version){const te=S.image;if(te===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(te.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Z(N,S,v);return}}t.bindTexture(i.TEXTURE_2D,N.__webglTexture,i.TEXTURE0+v)}function Y(S,v){const N=n.get(S);if(S.version>0&&N.__version!==S.version){Z(N,S,v);return}t.bindTexture(i.TEXTURE_2D_ARRAY,N.__webglTexture,i.TEXTURE0+v)}function W(S,v){const N=n.get(S);if(S.version>0&&N.__version!==S.version){Z(N,S,v);return}t.bindTexture(i.TEXTURE_3D,N.__webglTexture,i.TEXTURE0+v)}function k(S,v){const N=n.get(S);if(S.version>0&&N.__version!==S.version){he(N,S,v);return}t.bindTexture(i.TEXTURE_CUBE_MAP,N.__webglTexture,i.TEXTURE0+v)}const K={[$r]:i.REPEAT,[It]:i.CLAMP_TO_EDGE,[jr]:i.MIRRORED_REPEAT},J={[xt]:i.NEAREST,[ys]:i.NEAREST_MIPMAP_NEAREST,[li]:i.NEAREST_MIPMAP_LINEAR,[Mt]:i.LINEAR,[fr]:i.LINEAR_MIPMAP_NEAREST,[yn]:i.LINEAR_MIPMAP_LINEAR},de={[Tl]:i.NEVER,[Ll]:i.ALWAYS,[Al]:i.LESS,[to]:i.LEQUAL,[bl]:i.EQUAL,[Cl]:i.GEQUAL,[wl]:i.GREATER,[Rl]:i.NOTEQUAL};function be(S,v,N){if(v.type===Kt&&e.has("OES_texture_float_linear")===!1&&(v.magFilter===Mt||v.magFilter===fr||v.magFilter===li||v.magFilter===yn||v.minFilter===Mt||v.minFilter===fr||v.minFilter===li||v.minFilter===yn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),N?(i.texParameteri(S,i.TEXTURE_WRAP_S,K[v.wrapS]),i.texParameteri(S,i.TEXTURE_WRAP_T,K[v.wrapT]),(S===i.TEXTURE_3D||S===i.TEXTURE_2D_ARRAY)&&i.texParameteri(S,i.TEXTURE_WRAP_R,K[v.wrapR]),i.texParameteri(S,i.TEXTURE_MAG_FILTER,J[v.magFilter]),i.texParameteri(S,i.TEXTURE_MIN_FILTER,J[v.minFilter])):(i.texParameteri(S,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(S,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE),(S===i.TEXTURE_3D||S===i.TEXTURE_2D_ARRAY)&&i.texParameteri(S,i.TEXTURE_WRAP_R,i.CLAMP_TO_EDGE),(v.wrapS!==It||v.wrapT!==It)&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.wrapS and Texture.wrapT should be set to THREE.ClampToEdgeWrapping."),i.texParameteri(S,i.TEXTURE_MAG_FILTER,C(v.magFilter)),i.texParameteri(S,i.TEXTURE_MIN_FILTER,C(v.minFilter)),v.minFilter!==xt&&v.minFilter!==Mt&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.minFilter should be set to THREE.NearestFilter or THREE.LinearFilter.")),v.compareFunction&&(i.texParameteri(S,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(S,i.TEXTURE_COMPARE_FUNC,de[v.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){const te=e.get("EXT_texture_filter_anisotropic");if(v.magFilter===xt||v.minFilter!==li&&v.minFilter!==yn||v.type===Kt&&e.has("OES_texture_float_linear")===!1||a===!1&&v.type===mi&&e.has("OES_texture_half_float_linear")===!1)return;(v.anisotropy>1||n.get(v).__currentAnisotropy)&&(i.texParameterf(S,te.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(v.anisotropy,r.getMaxAnisotropy())),n.get(v).__currentAnisotropy=v.anisotropy)}}function H(S,v){let N=!1;S.__webglInit===void 0&&(S.__webglInit=!0,v.addEventListener("dispose",w));const te=v.source;let q=p.get(te);q===void 0&&(q={},p.set(te,q));const Q=G(v);if(Q!==S.__cacheKey){q[Q]===void 0&&(q[Q]={texture:i.createTexture(),usedTimes:0},o.memory.textures++,N=!0),q[Q].usedTimes++;const pe=q[S.__cacheKey];pe!==void 0&&(q[S.__cacheKey].usedTimes--,pe.usedTimes===0&&x(v)),S.__cacheKey=Q,S.__webglTexture=q[Q].texture}return N}function Z(S,v,N){let te=i.TEXTURE_2D;(v.isDataArrayTexture||v.isCompressedArrayTexture)&&(te=i.TEXTURE_2D_ARRAY),v.isData3DTexture&&(te=i.TEXTURE_3D);const q=H(S,v),Q=v.source;t.bindTexture(te,S.__webglTexture,i.TEXTURE0+N);const pe=n.get(Q);if(Q.version!==pe.__version||q===!0){t.activeTexture(i.TEXTURE0+N);const ae=qe.getPrimaries(qe.workingColorSpace),ue=v.colorSpace===Lt?null:qe.getPrimaries(v.colorSpace),ye=v.colorSpace===Lt||ae===ue?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,v.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,v.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,ye);const De=h(v)&&d(v.image)===!1;let $=M(v.image,De,!1,r.maxTextureSize);$=Pe(v,$);const Ye=d($)||a,Be=s.convert(v.format,v.colorSpace);let Re=s.convert(v.type),ve=R(v.internalFormat,Be,Re,v.colorSpace,v.isVideoTexture);be(te,v,Ye);let le;const Ie=v.mipmaps,b=a&&v.isVideoTexture!==!0&&ve!==Qa,ie=pe.__version===void 0||q===!0,oe=Q.dataReady,xe=P(v,$,Ye);if(v.isDepthTexture)ve=i.DEPTH_COMPONENT,a?v.type===Kt?ve=i.DEPTH_COMPONENT32F:v.type===on?ve=i.DEPTH_COMPONENT24:v.type===Tn?ve=i.DEPTH24_STENCIL8:ve=i.DEPTH_COMPONENT16:v.type===Kt&&console.error("WebGLRenderer: Floating point depth texture requires WebGL2."),v.format===An&&ve===i.DEPTH_COMPONENT&&v.type!==ts&&v.type!==on&&(console.warn("THREE.WebGLRenderer: Use UnsignedShortType or UnsignedIntType for DepthFormat DepthTexture."),v.type=on,Re=s.convert(v.type)),v.format===ni&&ve===i.DEPTH_COMPONENT&&(ve=i.DEPTH_STENCIL,v.type!==Tn&&(console.warn("THREE.WebGLRenderer: Use UnsignedInt248Type for DepthStencilFormat DepthTexture."),v.type=Tn,Re=s.convert(v.type))),ie&&(b?t.texStorage2D(i.TEXTURE_2D,1,ve,$.width,$.height):t.texImage2D(i.TEXTURE_2D,0,ve,$.width,$.height,0,Be,Re,null));else if(v.isDataTexture)if(Ie.length>0&&Ye){b&&ie&&t.texStorage2D(i.TEXTURE_2D,xe,ve,Ie[0].width,Ie[0].height);for(let T=0,ee=Ie.length;T<ee;T++)le=Ie[T],b?oe&&t.texSubImage2D(i.TEXTURE_2D,T,0,0,le.width,le.height,Be,Re,le.data):t.texImage2D(i.TEXTURE_2D,T,ve,le.width,le.height,0,Be,Re,le.data);v.generateMipmaps=!1}else b?(ie&&t.texStorage2D(i.TEXTURE_2D,xe,ve,$.width,$.height),oe&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,$.width,$.height,Be,Re,$.data)):t.texImage2D(i.TEXTURE_2D,0,ve,$.width,$.height,0,Be,Re,$.data);else if(v.isCompressedTexture)if(v.isCompressedArrayTexture){b&&ie&&t.texStorage3D(i.TEXTURE_2D_ARRAY,xe,ve,Ie[0].width,Ie[0].height,$.depth);for(let T=0,ee=Ie.length;T<ee;T++)le=Ie[T],v.format!==Nt?Be!==null?b?oe&&t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,T,0,0,0,le.width,le.height,$.depth,Be,le.data,0,0):t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,T,ve,le.width,le.height,$.depth,0,le.data,0,0):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):b?oe&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,T,0,0,0,le.width,le.height,$.depth,Be,Re,le.data):t.texImage3D(i.TEXTURE_2D_ARRAY,T,ve,le.width,le.height,$.depth,0,Be,Re,le.data)}else{b&&ie&&t.texStorage2D(i.TEXTURE_2D,xe,ve,Ie[0].width,Ie[0].height);for(let T=0,ee=Ie.length;T<ee;T++)le=Ie[T],v.format!==Nt?Be!==null?b?oe&&t.compressedTexSubImage2D(i.TEXTURE_2D,T,0,0,le.width,le.height,Be,le.data):t.compressedTexImage2D(i.TEXTURE_2D,T,ve,le.width,le.height,0,le.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):b?oe&&t.texSubImage2D(i.TEXTURE_2D,T,0,0,le.width,le.height,Be,Re,le.data):t.texImage2D(i.TEXTURE_2D,T,ve,le.width,le.height,0,Be,Re,le.data)}else if(v.isDataArrayTexture)b?(ie&&t.texStorage3D(i.TEXTURE_2D_ARRAY,xe,ve,$.width,$.height,$.depth),oe&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,$.width,$.height,$.depth,Be,Re,$.data)):t.texImage3D(i.TEXTURE_2D_ARRAY,0,ve,$.width,$.height,$.depth,0,Be,Re,$.data);else if(v.isData3DTexture)b?(ie&&t.texStorage3D(i.TEXTURE_3D,xe,ve,$.width,$.height,$.depth),oe&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,$.width,$.height,$.depth,Be,Re,$.data)):t.texImage3D(i.TEXTURE_3D,0,ve,$.width,$.height,$.depth,0,Be,Re,$.data);else if(v.isFramebufferTexture){if(ie)if(b)t.texStorage2D(i.TEXTURE_2D,xe,ve,$.width,$.height);else{let T=$.width,ee=$.height;for(let j=0;j<xe;j++)t.texImage2D(i.TEXTURE_2D,j,ve,T,ee,0,Be,Re,null),T>>=1,ee>>=1}}else if(Ie.length>0&&Ye){b&&ie&&t.texStorage2D(i.TEXTURE_2D,xe,ve,Ie[0].width,Ie[0].height);for(let T=0,ee=Ie.length;T<ee;T++)le=Ie[T],b?oe&&t.texSubImage2D(i.TEXTURE_2D,T,0,0,Be,Re,le):t.texImage2D(i.TEXTURE_2D,T,ve,Be,Re,le);v.generateMipmaps=!1}else b?(ie&&t.texStorage2D(i.TEXTURE_2D,xe,ve,$.width,$.height),oe&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,Be,Re,$)):t.texImage2D(i.TEXTURE_2D,0,ve,Be,Re,$);y(v,Ye)&&g(te),pe.__version=Q.version,v.onUpdate&&v.onUpdate(v)}S.__version=v.version}function he(S,v,N){if(v.image.length!==6)return;const te=H(S,v),q=v.source;t.bindTexture(i.TEXTURE_CUBE_MAP,S.__webglTexture,i.TEXTURE0+N);const Q=n.get(q);if(q.version!==Q.__version||te===!0){t.activeTexture(i.TEXTURE0+N);const pe=qe.getPrimaries(qe.workingColorSpace),ae=v.colorSpace===Lt?null:qe.getPrimaries(v.colorSpace),ue=v.colorSpace===Lt||pe===ae?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,v.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,v.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,ue);const ye=v.isCompressedTexture||v.image[0].isCompressedTexture,De=v.image[0]&&v.image[0].isDataTexture,$=[];for(let T=0;T<6;T++)!ye&&!De?$[T]=M(v.image[T],!1,!0,r.maxCubemapSize):$[T]=De?v.image[T].image:v.image[T],$[T]=Pe(v,$[T]);const Ye=$[0],Be=d(Ye)||a,Re=s.convert(v.format,v.colorSpace),ve=s.convert(v.type),le=R(v.internalFormat,Re,ve,v.colorSpace),Ie=a&&v.isVideoTexture!==!0,b=Q.__version===void 0||te===!0,ie=q.dataReady;let oe=P(v,Ye,Be);be(i.TEXTURE_CUBE_MAP,v,Be);let xe;if(ye){Ie&&b&&t.texStorage2D(i.TEXTURE_CUBE_MAP,oe,le,Ye.width,Ye.height);for(let T=0;T<6;T++){xe=$[T].mipmaps;for(let ee=0;ee<xe.length;ee++){const j=xe[ee];v.format!==Nt?Re!==null?Ie?ie&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+T,ee,0,0,j.width,j.height,Re,j.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+T,ee,le,j.width,j.height,0,j.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Ie?ie&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+T,ee,0,0,j.width,j.height,Re,ve,j.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+T,ee,le,j.width,j.height,0,Re,ve,j.data)}}}else{xe=v.mipmaps,Ie&&b&&(xe.length>0&&oe++,t.texStorage2D(i.TEXTURE_CUBE_MAP,oe,le,$[0].width,$[0].height));for(let T=0;T<6;T++)if(De){Ie?ie&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+T,0,0,0,$[T].width,$[T].height,Re,ve,$[T].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+T,0,le,$[T].width,$[T].height,0,Re,ve,$[T].data);for(let ee=0;ee<xe.length;ee++){const me=xe[ee].image[T].image;Ie?ie&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+T,ee+1,0,0,me.width,me.height,Re,ve,me.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+T,ee+1,le,me.width,me.height,0,Re,ve,me.data)}}else{Ie?ie&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+T,0,0,0,Re,ve,$[T]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+T,0,le,Re,ve,$[T]);for(let ee=0;ee<xe.length;ee++){const j=xe[ee];Ie?ie&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+T,ee+1,0,0,Re,ve,j.image[T]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+T,ee+1,le,Re,ve,j.image[T])}}}y(v,Be)&&g(i.TEXTURE_CUBE_MAP),Q.__version=q.version,v.onUpdate&&v.onUpdate(v)}S.__version=v.version}function Se(S,v,N,te,q,Q){const pe=s.convert(N.format,N.colorSpace),ae=s.convert(N.type),ue=R(N.internalFormat,pe,ae,N.colorSpace);if(!n.get(v).__hasExternalTextures){const De=Math.max(1,v.width>>Q),$=Math.max(1,v.height>>Q);q===i.TEXTURE_3D||q===i.TEXTURE_2D_ARRAY?t.texImage3D(q,Q,ue,De,$,v.depth,0,pe,ae,null):t.texImage2D(q,Q,ue,De,$,0,pe,ae,null)}t.bindFramebuffer(i.FRAMEBUFFER,S),ge(v)?l.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,te,q,n.get(N).__webglTexture,0,we(v)):(q===i.TEXTURE_2D||q>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&q<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,te,q,n.get(N).__webglTexture,Q),t.bindFramebuffer(i.FRAMEBUFFER,null)}function Te(S,v,N){if(i.bindRenderbuffer(i.RENDERBUFFER,S),v.depthBuffer&&!v.stencilBuffer){let te=a===!0?i.DEPTH_COMPONENT24:i.DEPTH_COMPONENT16;if(N||ge(v)){const q=v.depthTexture;q&&q.isDepthTexture&&(q.type===Kt?te=i.DEPTH_COMPONENT32F:q.type===on&&(te=i.DEPTH_COMPONENT24));const Q=we(v);ge(v)?l.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Q,te,v.width,v.height):i.renderbufferStorageMultisample(i.RENDERBUFFER,Q,te,v.width,v.height)}else i.renderbufferStorage(i.RENDERBUFFER,te,v.width,v.height);i.framebufferRenderbuffer(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.RENDERBUFFER,S)}else if(v.depthBuffer&&v.stencilBuffer){const te=we(v);N&&ge(v)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,te,i.DEPTH24_STENCIL8,v.width,v.height):ge(v)?l.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,te,i.DEPTH24_STENCIL8,v.width,v.height):i.renderbufferStorage(i.RENDERBUFFER,i.DEPTH_STENCIL,v.width,v.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.RENDERBUFFER,S)}else{const te=v.isWebGLMultipleRenderTargets===!0?v.texture:[v.texture];for(let q=0;q<te.length;q++){const Q=te[q],pe=s.convert(Q.format,Q.colorSpace),ae=s.convert(Q.type),ue=R(Q.internalFormat,pe,ae,Q.colorSpace),ye=we(v);N&&ge(v)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,ye,ue,v.width,v.height):ge(v)?l.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,ye,ue,v.width,v.height):i.renderbufferStorage(i.RENDERBUFFER,ue,v.width,v.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function fe(S,v){if(v&&v.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(i.FRAMEBUFFER,S),!(v.depthTexture&&v.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!n.get(v.depthTexture).__webglTexture||v.depthTexture.image.width!==v.width||v.depthTexture.image.height!==v.height)&&(v.depthTexture.image.width=v.width,v.depthTexture.image.height=v.height,v.depthTexture.needsUpdate=!0),z(v.depthTexture,0);const te=n.get(v.depthTexture).__webglTexture,q=we(v);if(v.depthTexture.format===An)ge(v)?l.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,te,0,q):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,te,0);else if(v.depthTexture.format===ni)ge(v)?l.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,te,0,q):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,te,0);else throw new Error("Unknown depthTexture format")}function ke(S){const v=n.get(S),N=S.isWebGLCubeRenderTarget===!0;if(S.depthTexture&&!v.__autoAllocateDepthBuffer){if(N)throw new Error("target.depthTexture not supported in Cube render targets");fe(v.__webglFramebuffer,S)}else if(N){v.__webglDepthbuffer=[];for(let te=0;te<6;te++)t.bindFramebuffer(i.FRAMEBUFFER,v.__webglFramebuffer[te]),v.__webglDepthbuffer[te]=i.createRenderbuffer(),Te(v.__webglDepthbuffer[te],S,!1)}else t.bindFramebuffer(i.FRAMEBUFFER,v.__webglFramebuffer),v.__webglDepthbuffer=i.createRenderbuffer(),Te(v.__webglDepthbuffer,S,!1);t.bindFramebuffer(i.FRAMEBUFFER,null)}function Le(S,v,N){const te=n.get(S);v!==void 0&&Se(te.__webglFramebuffer,S,S.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),N!==void 0&&ke(S)}function U(S){const v=S.texture,N=n.get(S),te=n.get(v);S.addEventListener("dispose",V),S.isWebGLMultipleRenderTargets!==!0&&(te.__webglTexture===void 0&&(te.__webglTexture=i.createTexture()),te.__version=v.version,o.memory.textures++);const q=S.isWebGLCubeRenderTarget===!0,Q=S.isWebGLMultipleRenderTargets===!0,pe=d(S)||a;if(q){N.__webglFramebuffer=[];for(let ae=0;ae<6;ae++)if(a&&v.mipmaps&&v.mipmaps.length>0){N.__webglFramebuffer[ae]=[];for(let ue=0;ue<v.mipmaps.length;ue++)N.__webglFramebuffer[ae][ue]=i.createFramebuffer()}else N.__webglFramebuffer[ae]=i.createFramebuffer()}else{if(a&&v.mipmaps&&v.mipmaps.length>0){N.__webglFramebuffer=[];for(let ae=0;ae<v.mipmaps.length;ae++)N.__webglFramebuffer[ae]=i.createFramebuffer()}else N.__webglFramebuffer=i.createFramebuffer();if(Q)if(r.drawBuffers){const ae=S.texture;for(let ue=0,ye=ae.length;ue<ye;ue++){const De=n.get(ae[ue]);De.__webglTexture===void 0&&(De.__webglTexture=i.createTexture(),o.memory.textures++)}}else console.warn("THREE.WebGLRenderer: WebGLMultipleRenderTargets can only be used with WebGL2 or WEBGL_draw_buffers extension.");if(a&&S.samples>0&&ge(S)===!1){const ae=Q?v:[v];N.__webglMultisampledFramebuffer=i.createFramebuffer(),N.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,N.__webglMultisampledFramebuffer);for(let ue=0;ue<ae.length;ue++){const ye=ae[ue];N.__webglColorRenderbuffer[ue]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,N.__webglColorRenderbuffer[ue]);const De=s.convert(ye.format,ye.colorSpace),$=s.convert(ye.type),Ye=R(ye.internalFormat,De,$,ye.colorSpace,S.isXRRenderTarget===!0),Be=we(S);i.renderbufferStorageMultisample(i.RENDERBUFFER,Be,Ye,S.width,S.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ue,i.RENDERBUFFER,N.__webglColorRenderbuffer[ue])}i.bindRenderbuffer(i.RENDERBUFFER,null),S.depthBuffer&&(N.__webglDepthRenderbuffer=i.createRenderbuffer(),Te(N.__webglDepthRenderbuffer,S,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(q){t.bindTexture(i.TEXTURE_CUBE_MAP,te.__webglTexture),be(i.TEXTURE_CUBE_MAP,v,pe);for(let ae=0;ae<6;ae++)if(a&&v.mipmaps&&v.mipmaps.length>0)for(let ue=0;ue<v.mipmaps.length;ue++)Se(N.__webglFramebuffer[ae][ue],S,v,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ae,ue);else Se(N.__webglFramebuffer[ae],S,v,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ae,0);y(v,pe)&&g(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Q){const ae=S.texture;for(let ue=0,ye=ae.length;ue<ye;ue++){const De=ae[ue],$=n.get(De);t.bindTexture(i.TEXTURE_2D,$.__webglTexture),be(i.TEXTURE_2D,De,pe),Se(N.__webglFramebuffer,S,De,i.COLOR_ATTACHMENT0+ue,i.TEXTURE_2D,0),y(De,pe)&&g(i.TEXTURE_2D)}t.unbindTexture()}else{let ae=i.TEXTURE_2D;if((S.isWebGL3DRenderTarget||S.isWebGLArrayRenderTarget)&&(a?ae=S.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY:console.error("THREE.WebGLTextures: THREE.Data3DTexture and THREE.DataArrayTexture only supported with WebGL2.")),t.bindTexture(ae,te.__webglTexture),be(ae,v,pe),a&&v.mipmaps&&v.mipmaps.length>0)for(let ue=0;ue<v.mipmaps.length;ue++)Se(N.__webglFramebuffer[ue],S,v,i.COLOR_ATTACHMENT0,ae,ue);else Se(N.__webglFramebuffer,S,v,i.COLOR_ATTACHMENT0,ae,0);y(v,pe)&&g(ae),t.unbindTexture()}S.depthBuffer&&ke(S)}function it(S){const v=d(S)||a,N=S.isWebGLMultipleRenderTargets===!0?S.texture:[S.texture];for(let te=0,q=N.length;te<q;te++){const Q=N[te];if(y(Q,v)){const pe=S.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:i.TEXTURE_2D,ae=n.get(Q).__webglTexture;t.bindTexture(pe,ae),g(pe),t.unbindTexture()}}}function Me(S){if(a&&S.samples>0&&ge(S)===!1){const v=S.isWebGLMultipleRenderTargets?S.texture:[S.texture],N=S.width,te=S.height;let q=i.COLOR_BUFFER_BIT;const Q=[],pe=S.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ae=n.get(S),ue=S.isWebGLMultipleRenderTargets===!0;if(ue)for(let ye=0;ye<v.length;ye++)t.bindFramebuffer(i.FRAMEBUFFER,ae.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ye,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,ae.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ye,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,ae.__webglMultisampledFramebuffer),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,ae.__webglFramebuffer);for(let ye=0;ye<v.length;ye++){Q.push(i.COLOR_ATTACHMENT0+ye),S.depthBuffer&&Q.push(pe);const De=ae.__ignoreDepthValues!==void 0?ae.__ignoreDepthValues:!1;if(De===!1&&(S.depthBuffer&&(q|=i.DEPTH_BUFFER_BIT),S.stencilBuffer&&(q|=i.STENCIL_BUFFER_BIT)),ue&&i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,ae.__webglColorRenderbuffer[ye]),De===!0&&(i.invalidateFramebuffer(i.READ_FRAMEBUFFER,[pe]),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[pe])),ue){const $=n.get(v[ye]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,$,0)}i.blitFramebuffer(0,0,N,te,0,0,N,te,q,i.NEAREST),c&&i.invalidateFramebuffer(i.READ_FRAMEBUFFER,Q)}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),ue)for(let ye=0;ye<v.length;ye++){t.bindFramebuffer(i.FRAMEBUFFER,ae.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ye,i.RENDERBUFFER,ae.__webglColorRenderbuffer[ye]);const De=n.get(v[ye]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,ae.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ye,i.TEXTURE_2D,De,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,ae.__webglMultisampledFramebuffer)}}function we(S){return Math.min(r.maxSamples,S.samples)}function ge(S){const v=n.get(S);return a&&S.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&v.__useRenderToTexture!==!1}function Ke(S){const v=o.render.frame;u.get(S)!==v&&(u.set(S,v),S.update())}function Pe(S,v){const N=S.colorSpace,te=S.format,q=S.type;return S.isCompressedTexture===!0||S.isVideoTexture===!0||S.format===Kr||N!==Jt&&N!==Lt&&(qe.getTransfer(N)===Ze?a===!1?e.has("EXT_sRGB")===!0&&te===Nt?(S.format=Kr,S.minFilter=Mt,S.generateMipmaps=!1):v=io.sRGBToLinear(v):(te!==Nt||q!==hn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",N)),v}this.allocateTextureUnit=L,this.resetTextureUnits=ne,this.setTexture2D=z,this.setTexture2DArray=Y,this.setTexture3D=W,this.setTextureCube=k,this.rebindTextures=Le,this.setupRenderTarget=U,this.updateRenderTargetMipmap=it,this.updateMultisampleRenderTarget=Me,this.setupDepthRenderbuffer=ke,this.setupFrameBufferTexture=Se,this.useMultisampledRTT=ge}function qf(i,e,t){const n=t.isWebGL2;function r(s,o=Lt){let a;const l=qe.getTransfer(o);if(s===hn)return i.UNSIGNED_BYTE;if(s===$a)return i.UNSIGNED_SHORT_4_4_4_4;if(s===ja)return i.UNSIGNED_SHORT_5_5_5_1;if(s===dl)return i.BYTE;if(s===fl)return i.SHORT;if(s===ts)return i.UNSIGNED_SHORT;if(s===qa)return i.INT;if(s===on)return i.UNSIGNED_INT;if(s===Kt)return i.FLOAT;if(s===mi)return n?i.HALF_FLOAT:(a=e.get("OES_texture_half_float"),a!==null?a.HALF_FLOAT_OES:null);if(s===pl)return i.ALPHA;if(s===Nt)return i.RGBA;if(s===ml)return i.LUMINANCE;if(s===gl)return i.LUMINANCE_ALPHA;if(s===An)return i.DEPTH_COMPONENT;if(s===ni)return i.DEPTH_STENCIL;if(s===Kr)return a=e.get("EXT_sRGB"),a!==null?a.SRGB_ALPHA_EXT:null;if(s===_l)return i.RED;if(s===Ka)return i.RED_INTEGER;if(s===vl)return i.RG;if(s===Za)return i.RG_INTEGER;if(s===Ja)return i.RGBA_INTEGER;if(s===pr||s===mr||s===gr||s===_r)if(l===Ze)if(a=e.get("WEBGL_compressed_texture_s3tc_srgb"),a!==null){if(s===pr)return a.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(s===mr)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(s===gr)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(s===_r)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(a=e.get("WEBGL_compressed_texture_s3tc"),a!==null){if(s===pr)return a.COMPRESSED_RGB_S3TC_DXT1_EXT;if(s===mr)return a.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(s===gr)return a.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(s===_r)return a.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(s===Ts||s===As||s===bs||s===ws)if(a=e.get("WEBGL_compressed_texture_pvrtc"),a!==null){if(s===Ts)return a.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(s===As)return a.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(s===bs)return a.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(s===ws)return a.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(s===Qa)return a=e.get("WEBGL_compressed_texture_etc1"),a!==null?a.COMPRESSED_RGB_ETC1_WEBGL:null;if(s===Rs||s===Cs)if(a=e.get("WEBGL_compressed_texture_etc"),a!==null){if(s===Rs)return l===Ze?a.COMPRESSED_SRGB8_ETC2:a.COMPRESSED_RGB8_ETC2;if(s===Cs)return l===Ze?a.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:a.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(s===Ls||s===Ps||s===Ds||s===Us||s===Is||s===Ns||s===Fs||s===Os||s===Bs||s===zs||s===Gs||s===Hs||s===Vs||s===ks)if(a=e.get("WEBGL_compressed_texture_astc"),a!==null){if(s===Ls)return l===Ze?a.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:a.COMPRESSED_RGBA_ASTC_4x4_KHR;if(s===Ps)return l===Ze?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:a.COMPRESSED_RGBA_ASTC_5x4_KHR;if(s===Ds)return l===Ze?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:a.COMPRESSED_RGBA_ASTC_5x5_KHR;if(s===Us)return l===Ze?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:a.COMPRESSED_RGBA_ASTC_6x5_KHR;if(s===Is)return l===Ze?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:a.COMPRESSED_RGBA_ASTC_6x6_KHR;if(s===Ns)return l===Ze?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:a.COMPRESSED_RGBA_ASTC_8x5_KHR;if(s===Fs)return l===Ze?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:a.COMPRESSED_RGBA_ASTC_8x6_KHR;if(s===Os)return l===Ze?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:a.COMPRESSED_RGBA_ASTC_8x8_KHR;if(s===Bs)return l===Ze?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:a.COMPRESSED_RGBA_ASTC_10x5_KHR;if(s===zs)return l===Ze?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:a.COMPRESSED_RGBA_ASTC_10x6_KHR;if(s===Gs)return l===Ze?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:a.COMPRESSED_RGBA_ASTC_10x8_KHR;if(s===Hs)return l===Ze?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:a.COMPRESSED_RGBA_ASTC_10x10_KHR;if(s===Vs)return l===Ze?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:a.COMPRESSED_RGBA_ASTC_12x10_KHR;if(s===ks)return l===Ze?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:a.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(s===vr||s===Ws||s===Xs)if(a=e.get("EXT_texture_compression_bptc"),a!==null){if(s===vr)return l===Ze?a.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:a.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(s===Ws)return a.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(s===Xs)return a.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(s===xl||s===Ys||s===qs||s===$s)if(a=e.get("EXT_texture_compression_rgtc"),a!==null){if(s===vr)return a.COMPRESSED_RED_RGTC1_EXT;if(s===Ys)return a.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(s===qs)return a.COMPRESSED_RED_GREEN_RGTC2_EXT;if(s===$s)return a.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return s===Tn?n?i.UNSIGNED_INT_24_8:(a=e.get("WEBGL_depth_texture"),a!==null?a.UNSIGNED_INT_24_8_WEBGL:null):i[s]!==void 0?i[s]:null}return{convert:r}}class $f extends Ct{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class Xi extends bt{constructor(){super(),this.isGroup=!0,this.type="Group"}}const jf={type:"move"};class Hr{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Xi,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Xi,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new I,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new I),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Xi,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new I,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new I),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const n of e.hand.values())this._getHandJoint(t,n)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,n){let r=null,s=null,o=null;const a=this._targetRay,l=this._grip,c=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(c&&e.hand){o=!0;for(const M of e.hand.values()){const d=t.getJointPose(M,n),h=this._getHandJoint(c,M);d!==null&&(h.matrix.fromArray(d.transform.matrix),h.matrix.decompose(h.position,h.rotation,h.scale),h.matrixWorldNeedsUpdate=!0,h.jointRadius=d.radius),h.visible=d!==null}const u=c.joints["index-finger-tip"],f=c.joints["thumb-tip"],p=u.position.distanceTo(f.position),m=.02,_=.005;c.inputState.pinching&&p>m+_?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!c.inputState.pinching&&p<=m-_&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(s=t.getPose(e.gripSpace,n),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));a!==null&&(r=t.getPose(e.targetRaySpace,n),r===null&&s!==null&&(r=s),r!==null&&(a.matrix.fromArray(r.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,r.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(r.linearVelocity)):a.hasLinearVelocity=!1,r.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(r.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(jf)))}return a!==null&&(a.visible=r!==null),l!==null&&(l.visible=s!==null),c!==null&&(c.visible=o!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const n=new Xi;n.matrixAutoUpdate=!1,n.visible=!1,e.joints[t.jointName]=n,e.add(n)}return e.joints[t.jointName]}}const Kf=`
void main() {
...
}`;function _p(i){const e=document.createElement("style");e.innerHTML=i;const t=document.querySelector("head link[rel=stylesheet], head style");t?document.head.insertBefore(e,t):document.head.appendChild(e)}let ka=!1;class ls{constructor({parent:e,autoPlace:t=e===void 0,container:n,width:r,title:s="Controls",closeFolders:o=!1,injectStyles:a=!0,touchStyles:l=!0}={}){if(this.parent=e,this.root=e?e.root:this,this.children=[],this.controllers=[],this.folders=[],this._closed=!1,this._hidden=!1,this.domElement=document.createElement("div"),this.domElement.classList.add("lil-gui"),this.$title=document.createElement("div"),this.$title.classList.add("title"),this.$title.setAttribute("role","button"),this.$title.setAttribute("aria-expanded",!0),this.$title.setAttribute("tabindex",0),this.$title.addEventListener("click",()=>this.openAnimated(this._closed)),this.$title.addEventListener("keydown",c=>{(c.code==="Enter"||c.code==="Space")&&(c.preventDefault(),this.$title.click())}),this.$title.addEventListener("touchstart",()=>{},{passive:!0}),this.$children=document.createElement("div"),this.$children.classList.add("children"),this.domElement.appendChild(this.$title),this.domElement.appendChild(this.$children),this.title(s),this.parent){this.parent.children.push(this),this.parent.folders.push(this),this.parent.$children.appendChild(this.domElement);return}this.domElement.classList.add("root"),l&&this.domElement.classList.add("allow-touch-styles"),!ka&&a&&(_p(gp),ka=!0),n?n.appendChild(this.domElement):t&&(this.domElement.classList.add("autoPlace"),document.body.appendChild(this.domElement)),r&&this.domElement.style.setProperty("--width",r+"px"),this._closeFolders=o}add(e,t,n,r,s){if(Object(n)===n)return new pp(this,e,t,n);const o=e[t];switch(typeof o){case"number":return new fp(this,e,t,n,r,s);case"boolean":return new ap(this,e,t);case"string":return new mp(this,e,t);case"function":return new kr(this,e,t)}console.error(`gui.add failed
	property:`,t,`
	object:`,e,`
	value:`,o)}addColor(e,t,n=1){return new dp(this,e,t,n)}addFolder(e){const t=new ls({parent:this,title:e});return this.root._closeFolders&&t.close(),t}load(e,t=!0){return e.controllers&&this.controllers.forEach(n=>{n instanceof kr||n._name in e.controllers&&n.load(e.controllers[n._name])}),t&&e.folders&&this.folders.forEach(n=>{n._title in e.folders&&n.load(e.folders[n._title])}),this}save(e=!0){const t={controllers:{},folders:{}};return this.controllers.forEach(n=>{if(!(n instanceof kr)){if(n._name in t.controllers)throw new Error(`Cannot save GUI with duplicate property "${n._name}"`);t.controllers[n._name]=n.save()}}),e&&this.folders.forEach(n=>{if(n._title in t.folders)throw new Error(`Cannot save GUI with duplicate folder "${n._title}"`);t.folders[n._title]=n.save()}),t}open(e=!0){return this._setClosed(!e),this.$title.setAttribute("aria-expanded",!this._closed),this.domElement.classList.toggle("closed",this._closed),this}close(){return this.open(!1)}_setClosed(e){this._closed!==e&&(this._closed=e,this._callOnOpenClose(this))}show(e=!0){return this._hidden=!e,this.domElement.style.display=this._hidden?"none":"",this}hide(){return this.show(!1)}openAnimated(e=!0){return this._setClosed(!e),this.$title.setAttribute("aria-expanded",!this._closed),requestAnimationFrame(()=>{const t=this.$children.clientHeight;this.$children.style.height=t+"px",this.domElement.classList.add("transition");const n=s=>{s.target===this.$children&&(this.$children.style.height="",this.domElement.classList.remove("transition"),this.$children.removeEventListener("transitionend",n))};this.$children.addEventListener("transitionend",n);const r=e?this.$children.scrollHeight:0;this.domElement.classList.toggle("closed",!e),requestAnimationFrame(()=>{this.$children.style.height=r+"px"})}),this}title(e){return this._title=e,this.$title.innerHTML=e,this}reset(e=!0){return(e?this.controllersRecursive():this.controllers).forEach(n=>n.reset()),this}onChange(e){return this._onChange=e,this}_callOnChange(e){this.parent&&this.parent._callOnChange(e),this._onChange!==void 0&&this._onChange.call(this,{object:e.object,property:e.property,value:e.getValue(),controller:e})}onFinishChange(e){return this._onFinishChange=e,this}_callOnFinishChange(e){this.parent&&this.parent._callOnFinishChange(e),this._onFinishChange!==void 0&&this._onFinishChange.call(this,{object:e.object,property:e.property,value:e.getValue(),controller:e})}onOpenClose(e){return this._onOpenClose=e,this}_callOnOpenClose(e){this.parent&&this.parent._callOnOpenClose(e),this._onOpenClose!==void 0&&this._onOpenClose.call(this,e)}destroy(){this.parent&&(this.parent.children.splice(this.parent.children.indexOf(this),1),this.parent.folders.splice(this.parent.folders.indexOf(this),1)),this.domElement.parentElement&&this.domElement.parentElement.removeChild(this.domElement),Array.from(this.children).forEach(e=>e.destroy())}controllersRecursive(){let e=Array.from(this.controllers);return this.folders.forEach(t=>{e=e.concat(t.controllersRecursive())}),e}foldersRecursive(){let e=Array.from(this.folders);return this.folders.forEach(t=>{e=e.concat(t.foldersRecursive())}),e}}const vp=(i,e,t)=>{window.addEventListener("resize",()=>{i.width=window.innerWidth,i.height=window.innerHeight,e.aspect=i.width/i.height,e.updateProjectionMatrix(),t.setSize(i.width,i.height),t.setPixelRatio(Math.min(window.devicePixelRatio,2))})};var xp=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function Mp(i){return i&&i.__esModule&&Object.prototype.hasOwnProperty.call(i,"default")?i.default:i}var To={exports:{}};(function(i,e){(function(t,n){i.exports=n()})(xp,function(){var t=function(){function n(m){return o.appendChild(m.dom),m}function r(m){for(var _=0;_<o.children.length;_++)o.children[_].style.display=_===m?"block":"none";s=m}var s=0,o=document.createElement("div");o.style.cssText="position:fixed;top:0;left:0;cursor:pointer;opacity:0.9;z-index:10000",o.addEventListener("click",function(m){m.preventDefault(),r(++s%o.children.length)},!1);var a=(performance||Date).now(),l=a,c=0,u=n(new t.Panel("FPS","#0ff","#002")),f=n(new t.Panel("MS","#0f0","#020"));if(self.performance&&self.performance.memory)var p=n(new t.Panel("MB","#f08","#201"));return r(0),{REVISION:16,dom:o,addPanel:n,showPanel:r,begin:function(){a=(performance||Date).now()},end:function(){c++;var m=(performance||Date).now();if(f.update(m-a,200),m>l+1e3&&(u.update(1e3*c/(m-l),100),l=m,c=0,p)){var _=performance.memory;p.update(_.usedJSHeapSize/1048576,_.jsHeapSizeLimit/1048576)}return m},update:function(){a=this.end()},domElement:o,setMode:r}};return t.Panel=function(n,r,s){var o=1/0,a=0,l=Math.round,c=l(window.devicePixelRatio||1),u=80*c,f=48*c,p=3*c,m=2*c,_=3*c,M=15*c,d=74*c,h=30*c,y=document.createElement("canvas");y.width=u,y.height=f,y.style.cssText="width:80px;height:48px";var g=y.getContext("2d");return g.font="bold "+9*c+"px Helvetica,Arial,sans-serif",g.textBaseline="top",g.fillStyle=s,g.fillRect(0,0,u,f),g.fillStyle=r,g.fillText(n,p,m),g.fillRect(_,M,d,h),g.fillStyle=s,g.globalAlpha=.9,g.fillRect(_,M,d,h),{dom:y,update:function(R,P){o=Math.min(o,R),a=Math.max(a,R),g.fillStyle=s,g.globalAlpha=1,g.fillRect(0,0,u,M),g.fillStyle=r,g.fillText(l(R)+" "+n+" ("+l(o)+"-"+l(a)+")",p,m),g.drawImage(y,_+c,M,d-c,h,_,M,d-c,h),g.fillRect(_+d-c,M,c,h),g.fillStyle=s,g.globalAlpha=.9,g.fillRect(_+d-c,M,c,l((1-R/P)*h))}}},t})})(To);var Ep=To.exports;const Sp=Mp(Ep),ri=new Sp;ri.dom.style.left="auto";ri.dom.style.top="10px";ri.dom.style.left="10px";document.body.appendChild(ri.dom);const yp=new ls,cs=document.querySelector("canvas.webgl");if(cs===null)throw new Error("Cannot find the canvas element");const hs=new ip,Ao=new Bt(new os(1,.4,100,16),new ss);Ao.position.y=4;hs.add(Ao);const vi={width:window.innerWidth,height:window.innerHeight},Ei=new Ct(75,vi.width/vi.height,.1,100);Ei.position.set(4,5,4);hs.add(Ei);const or=new sp(Ei,cs);or.target.y=3.5;or.enableDamping=!0;const lr=new yo({canvas:cs,antialias:!0});lr.setSize(vi.width,vi.height);lr.setPixelRatio(Math.min(window.devicePixelRatio,2));const bo=()=>{ri.begin(),or.update(),lr.render(hs,Ei),ri.end(),requestAnimationFrame(bo)};bo();vp(vi,Ei,lr);yp.add(or,"autoRotate");
